...
CREATE TABLE `t_ad`  (
  ...
  `ad_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '广告类型：banner、sidebar、popup、feed',
...
) ENGINE = InnoDB AUTO_INCREMENT = 16 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '博主信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for t_blo_python
-- ----------------------------
DROP TABLE IF EXISTS `t_blo_python`;
CREATE TABLE `t_blo_python`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '序号（自增）',
  `blogger_uid` bigint NOT NULL COMMENT '博主UID（前端输入，不允许为空）',
  `blogger_nickname` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '博主昵称',
  `homepage_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '主页地址（前端输入，不允许为空）',
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'not_updated' COMMENT '状态：updated-已更新、not_updated-未更新',
  `is_delete` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'N' COMMENT '是否删除：N-未删除，Y-已删除',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Python爬虫博主表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 31 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '分类主表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_content_chapter`  (
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 47 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '内容章节表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_goods`  (
  ...
  `stock` int NULL DEFAULT -1 COMMENT '库存数量（-1表示无限库存，适用于虚拟商品）',
  ...
  `seller_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '商家名称（冗余）',
  ...
  `sales_count` bigint NULL DEFAULT 0 COMMENT '销量（冗余统计）',
  `view_count` bigint NULL DEFAULT 0 COMMENT '查看数（冗余统计）',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  ...
  INDEX `idx_coin_price`(`coin_price` ASC) USING BTREE,
  INDEX `idx_content_id`(`content_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品主表（支持金币、商品、订阅、内容四种类型）' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_user`  (
  ...
  `status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'active' COMMENT '用户状态：active、inactive、suspended、banned',
...
CREATE TABLE `t_user_interest_tag`  (
  ...
  INDEX `idx_user_id`(`user_id` ASC) USING BTREE,
  INDEX `idx_tag_id`(`tag_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户兴趣标签关联表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户钱包表（支持现金+金币）' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_vip_power`  (
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'VIP特权文案表' ROW_FORMAT = DYNAMIC;
